...
require([
  "swiper-bundle.min",			//スライダーJS
	...
	//スタッフのスライダー
	const mySwiperTypeStaff = new Swiper('.sliderBox--typeStaff .swiper', {
		slidesPerView: 1,
		spaceBetween: 24,
		grabCursor: true,
		pagination: {
			el: '.sliderBox--typeStaff .swiper-pagination',
			clickable: true,
		},
	    	navigation: {
	      		nextEl: '.sliderBox--typeStaff .swiper-button-next',
	      		prevEl: '.sliderBox--typeStaff .swiper-button-prev',
	    	},
	    	breakpoints: {
	      		600: {
	        		slidesPerView: 1,
	...
	//コンテンツのスライダー
	  ...
	  const initSwiperTypeChangeSlide = () => {
	    ...
	    mySwiperTypeChangeSlideTypeBlog = new Swiper('.sliderBox--typeChangeSlide--typeBlog .swiper', {
	      slidesPerView: 1,
	      spaceBetween: 16,
	      loop: true,
	      loopAdditionalSlides: 1,
	      ...
	      grabCursor: true,
	      pagination: {
	        el: '.sliderBox--typeChangeSlide--typeBlog .swiper-pagination', // ページネーション要素のクラス
	        clickable: true, //クリックを有効化する
	      },
	      navigation: {
	        nextEl: '.sliderBox--typeChangeSlide--typeBlog .swiper-button-next',
	        prevEl: '.sliderBox--typeChangeSlide--typeBlog .swiper-button-prev',
	      },
	      breakpoints: {
	        600: {// 画面幅600px以上で適用
	          slidesPerView: 1,
